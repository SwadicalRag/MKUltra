 ...
 */
public class VampiricRevere extends BaseToggleAbility {
    ...
    public void applyEffect(EntityPlayer entity, IPlayerData pData, World theWorld) {
        ...
        entity.addPotionEffect(VampiricReverePotion.Create(this, entity).setTarget(entity).toPotionEffect(BASE_DURATION, level));
